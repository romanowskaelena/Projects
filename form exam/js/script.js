...
function checkEquality(){
    ...
    if(value1 == value2 && value1 == value3){
        document.querySelector(".resultEquality").innerText = `all fields are equal`;
    } else {
        document.querySelector(".resultEquality").innerText = `all fields are NOT equal`;
    }
}
...
function hasZero(){
    ...
    if (value1 == 0 || value2 == 0 || value3 == 0) {
        document.querySelector(".resultZero").innerText = `yes, there are zeros`;  
    } else {
        document.querySelector(".resultZero").innerText = `no zeros`; 
    }
}
...
function sameOne(){
    ...
    if (value1 == value2 || value1 == value3 || value2 == value3) {
        document.querySelector(".resultSame").innerText = `yes, there are matches`;  
    } else {
        document.querySelector(".resultSame").innerText = `no matches`; 
    }
}
